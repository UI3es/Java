/*
 * 
 * An array of random integer intervals [0; 9]
 * 
 */
package lab_3_3;
...
public class Lab_3_3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("An array of random integer intervals [0; 9]:");

        int[] nums = new int[15];

        Lab_3_3.randomFillArray(nums, 0, 9);
        Lab_3_3.printArray(nums, " ");

        int[] evenOddCount = Lab_3_3.getEvenOddCount(nums);
        System.out.println("Even elements: " + evenOddCount[0]);
        System.out.println("Odd elements: " + evenOddCount[1]);
