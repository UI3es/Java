...
public class Lab_7_1 {
    ...
    public static void main(String[] args) {
        ...
        Cow cow = new Whale(); cow.getName(); 
            ...
            System.out.println("\n");
                Lab_7_1.printClassName(cat);
                Lab_7_1.printClassName(dog);
            
            System.out.println("\n");
                Lab_7_1.print(Lab_7_1.max(1,2));	
                Lab_7_1.print(Lab_7_1.max(1l,2l));
                Lab_7_1.print(Lab_7_1.max(1d,2d));
            
            System.out.println("\n");
                Lab_7_1.print(Lab_7_1.min(1,2));	
                Lab_7_1.print(Lab_7_1.min(1l,2l));
                Lab_7_1.print(Lab_7_1.min(1d,2d));
